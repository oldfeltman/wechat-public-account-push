...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxff87b3b116640b7b',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '2acda4617ac2cea600470545fd3b1d06',
  ...
  USERS: [
    {
      ...
      id: '',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'Sh5yLgqNaZC84lebeZLbvBGAcgxalutNy8H 1Pb8ltt8',
      // 所在省份
      province: '宁夏',
      // 所在城市
      city: '中卫',
  ...
  CALLBACK_TEMPLATE_ID: 'Sh5yLgqNaZC84lebeZLbvBGAcgxalutNy8H 1Pb8ltt8',
  ...
  FESTIVALS: [
    ...
    {
      type: '02-22', name: '生日', year: '2003', date: '02-22',
    },
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
    {
      type: '02-22', name: '轩轩', year: '2003', date: '02-22', isShowAge: true,
    },
    {
      type: '02-22', name: '被搭讪纪念日', year: '2021', date: '09-01',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
